...
- **Morpho v2 vaults will fail** with `Contract Function Execution Error: Execution reverted` — the SDK only supports v1 ABIs. Skip these vaults.
...
3. **v2 vaults cannot be added** — the Morpho SDK only supports v1 vault ABIs.
